...
namespace TopTenBooksV.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(BookNookContext context)
        {
            _context = context;
        }
        ...
        {
            var bookNookContext = _context.Payment.Include(p => p.Order).Include(p => p.User);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Readers, "Id", "Address");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,CardNumber,VerificationNumber,UserId,OrderId,ExperationDate")] Payment payment)
        {
