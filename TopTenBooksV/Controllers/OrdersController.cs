...
namespace TopTenBooksV.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var bookNookContext = _context.Orders.Include(o => o.Book).Include(o => o.User);
        ...
        {
            ViewData["BookId"] = new SelectList(_context.Library, "BookId", "AuthorName");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,BookId,BookPrice,UserId")] Orders orders)
        {
